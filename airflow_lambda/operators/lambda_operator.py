...
class LambdaOperator(BaseOperator):
    """
    this operator comes from https://github.com/yashap/airflow
    """
    ...
    def execute(self, context):
        request_payload = self.context_to_payload(context) # type: dict

        logging.info('make the following request against AWS Lambda %s' % request_payload)
